...
is derived from the Astrores format \citep{astrores}, itself modelled on the FITS Table format 
...
The Observation Locator Table Access Protocol (ObsLocTAP) (TODO: cite from ivoabib needed) 
...
\begin{longtable}[t]{l l}
        ...
        {VODataService} &
        {Virtual Observatory Data Service service metadata - standard} \\
        {VO-DML} &
        ...
        {VOSI} &
        {Virtual Observatory Support Interfaces - common components standard} \\
        {VOSpace} &
